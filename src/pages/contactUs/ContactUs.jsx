      ...
      <Container>
        <div className="writingSection">
          ...
          <Grid container spacing={2}>
            <Grid item sm={6}>
              <label>Name<span className="text-danger ml-1">*</span></label>
              <br></br>
              <TextField id="outlined-basic" variant="outlined" className="inputTexts" />
            </Grid>
            <Grid item sm={6}>
              <label>Email<span className="text-danger ml-1">*</span></label>
              <br></br>
              <TextField id="outlined-basic" variant="outlined" className="inputTexts" />
            </Grid>
          </Grid>
          <br></br>
          <p>
            <label>Message<span className="text-danger ml-1">*</span></label><br></br>
            <span className="wpcf7-form-control-wrap" data-name="message-en">
              <textarea cols="40" rows="10" id="message" name="message-en" className="form-control" aria-required="true" aria-invalid="false"> </textarea>
            </span>
          </p>
